# Chapter 07 - Build articles, comments, search
...
## 07.02 - Why This Feature Matters

Articles and comments matters because it changes how the portfolio behaves for real users. It is not a decorative layer; it affects what visitors can see, what the owner can manage, and what proof the final demo can show.
...
## 07.12 - Write The First Screen Or Helper

Build the first visible or reusable piece for articles and comments. Keep it intentionally small: one screen shell, one helper contract, or one component boundary.
...
## 07.14 - Add Loading And Empty State

Add loading and empty states for articles and comments. A user should never have to guess whether the app is waiting, empty, broken, or rejecting their input.
...
## 07.15 - Add Error And Validation State

Add error and validation states for articles and comments. A user should never have to guess whether the app is waiting, empty, broken, or rejecting their input.
...
For `articles and comments`, the query or function should respect:
...
## 07.22 - Write The Learning Log

Create or update `learning-log/07-articles-comments-search.md`.

Answer these in your own words:

```txt
What did Chapter 07 add to the project?
